""" Tarea 1 Estructuras de Computadoras II    -    I Semestre 2024
    Codigo que llama a los distintos predictores de saltos
...
parser.add_option("-g", dest="history_size")
...
#Si --bp 1 entonces usamos g-shared
    ...
    branch_predictor = gshared(int(options.bits_to_index),int(options.history_size))
    branch_predictor.print_info()
#Si --bp 2 entonces usamos p-shared
    ...
    branch_predictor = pshared(int(options.bits_to_index),int(options.history_size)) 
    branch_predictor.print_info()
...
if options.branch_predictor_type == "3":
    ...
    branch_predictor = perceptron(int(options.bits_to_index),int(options.history_size))
    branch_predictor.print_info()  
